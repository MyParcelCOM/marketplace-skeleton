...
use MyParcelCom\Integration\Order\Http\Requests\OrdersCountRequest;
...
use MyParcelCom\Integration\Order\Http\Responses\OrdersCountResponse;
...
{
    public function get(string $orderId, FormRequest $request): ProvidesJsonAPI
    {
